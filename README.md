...
If this is not what you need, you have to switch to **Manual Configuration**
 ...
 | [ESP32-S3 PowerFeather](https://www.powerfeather.dev/) with [Adafruit LoRa Radio FeatherWing](https://www.adafruit.com/product/3231) | "ESP32-S3 PowerFeather" / V2 | n.a.            | ARDUINO_ESP32S3_POWERFEATHER   | SX1276 (RFM95W) | Wiring on the Featherwing:<br>A to RST<br>B to DIO1<br>D to IRQ<br>E to CS<br><br>Install PowerFeather-SDK 2.1.4 or newer. Select `ESP32-S3 PowerFeather` for V1 or `ESP32-S3 PowerFeather V2` for V2 in the Arduino IDE board revision menu.<br><br>`Board.init();` is called to control power management |
